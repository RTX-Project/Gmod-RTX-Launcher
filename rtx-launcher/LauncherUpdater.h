...
public:
    inline static const std::wstring CURRENT_VERSION = L"0.0.2.6.1";
    inline static const int CURRENT_BUILD_NUMBER = 231; // Use black semi-transparent background for card badges
