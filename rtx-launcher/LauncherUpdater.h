...
public:
    inline static const std::wstring CURRENT_VERSION = L"0.0.2.6.5";
    inline static const int CURRENT_BUILD_NUMBER = 256; // Use black semi-transparent background for card badges
