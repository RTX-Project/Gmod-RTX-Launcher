...
public:
    inline static const std::wstring CURRENT_VERSION = L"0.0.2.5";
    inline static const int CURRENT_BUILD_NUMBER = 196; // Use black semi-transparent background for card badges
